...
### 4. Learning-based re-rankers

**gte-multilingual-reranker-base**

*CQAD(en), $k_0=10$*

|  | FTS+SVS | FTS+DVS | SVS+DVS | FTS+SVS+DVS |
| ---- | ---- | ---- | ---- | ---- |
| Query Latency (ms) | 74.41519521603918 | 64.12574166704894 | 74.5896413827398 | 104.91260404040099 |
| nDCG@10 | 0.48669247453799147 | 0.5122218167221083 | 0.5162376042463476 | 0.5122500142844025 |
| Peak Memory (MB) | 1181.64 | 1175.97 | 1179.90 | 1183.00 |
...
|  | FTS+SVS | FTS+DVS | SVS+DVS | FTS+SVS+DVS |
| ---- | ---- | ---- | ---- | ---- |
| Query Latency (ms) | 872.4119110471884 | 865.1154829438325 | 872.8103589100443 | 1199.7983249129763 |
| nDCG@10 | 0.47818019465818407 | 0.48459723547035755 | 0.48722601543930516 | 0.4804772178987473 |
| Peak Memory (MB) | 1234.01 | 1232.75 | 1232.39 | 1235.75 |
...
|  | FTS+SVS | FTS+DVS | SVS+DVS | FTS+SVS+DVS |
| ---- | ---- | ---- | ---- | ---- |
| Query Latency (ms) | 234.27635073661804 | 228.98591607809067 | 245.17947018146515 | 290.3832298517227 |
| nDCG@10 | 0.4710890693080137 | 0.4538854565771465 | 0.4661535390577978 | 0.4377698072375682 |
| Peak Memory (MB) | 9352.60 | 9465.48 | 9428.34 | 9634.41 |
...
|  | FTS+SVS | FTS+DVS | SVS+DVS | FTS+SVS+DVS |
| ---- | ---- | ---- | ---- | ---- |
| Query Latency (ms) | 1390.3081250190735 | 1428.8999661803246 | 1509.087101817131 | 2002.6428657770157 |
| nDCG@10 | 0.34800256398121626 | 0.34658719808075156 | 0.36091446074213485 | 0.34002798062152645 |
| Peak Memory (MB) | 10671.30 | 10664.96 | 10576.57 | 10781.55 |
...
|  | FTS+SVS | FTS+DVS | SVS+DVS | FTS+SVS+DVS |
| ---- | ---- | ---- | ---- | ---- |
| Query Latency (ms) | 189.38004271999287 | 166.89155602910716 | 193.9232502773309 | 278.5104326381805 |
| nDCG@10 | 0.4859335210501031 | 0.5138834344720883 | 0.5145127028510548 | 0.5110114705485322 |
| Peak Memory (MB) | 1521.50 | 1509.02 | 1517.35 | 1514.94 |

*CQAD(en), $k_0=100$*
			
|  | FTS+SVS | FTS+DVS | SVS+DVS | FTS+SVS+DVS |
| ---- | ---- | ---- | ---- | ---- |
| Query Latency (ms) | 2222.8772626560963 | 2171.458654950379 | 2204.7841591440188 | 3083.500187412189 |
| nDCG@10 | 0.48463788522129087 | 0.48996697325181277 | 0.494230841331943 | 0.4882261250129837 |
| Peak Memory (MB) | 1541.45 | 1535.05 | 1530.55 | 1544.30 |
...
|  | FTS+SVS | FTS+DVS | SVS+DVS | FTS+SVS+DVS |
| ---- | ---- | ---- | ---- | ---- |
| Query Latency (ms) | 339.49070632457733 | 348.1158021092415 | 350.8955430984497 | 452.2729289531708 |
| nDCG@10 | 0.48800541834732464 | 0.4716391108693279 | 0.48041946734682256 | 0.456368421703264 |
| Peak Memory (MB) | 9396.49 | 9523.87 | 9424.18 | 9639.57 |

*MLDR(en), $k_0=100$*
			
|  | FTS+SVS | FTS+DVS | SVS+DVS | FTS+SVS+DVS |
| ---- | ---- | ---- | ---- | ---- |
| Query Latency (ms) | 2910.742500424385 | 2972.3776486516 | 3005.2261286973953 | 4018.3076083660126 |
| nDCG@10 | 0.39692334296109544 | 0.3939364044948695 | 0.407279850109239 | 0.38823545907960094 |
| Peak Memory (MB) | 10701.42 | 10710.30 | 10604.81 | 10843.27 |

### 5. Recall@10 & MRR@10

**CQAD(en), RRF Re-ranking, k0=10**

|  | FTS | SVS | DVS | FTS+SVS | FTS+DVS | SVS+DVS | FTS+SVS+DVS |
| ---- | ---- | ---- | ---- | ---- | ---- | ---- | ---- |
| Recall | 0.428 | 0.4297 | 0.5447 | 0.4842 | 0.516 | 0.5194 | 0.5364 |
| MRR | 0.371 | 0.3825 | 0.4389 | 0.4122 | 0.4287 | 0.425 | 0.4517 |


**CQAD(en), Tensor Re-ranking, k0=10**

|  | FTS | SVS | DVS | FTS+SVS | FTS+DVS | SVS+DVS | FTS+SVS+DVS |
| ---- | ---- | ---- | ---- | ---- | ---- | ---- | ---- |
| Recall | 0.428 | 0.4297 | 0.5447 | 0.4747 | 0.5084 | 0.5017 | 0.5092 |
| MRR | 0.371 | 0.3825 | 0.4389 | 0.4173 | 0.4286 | 0.4294 | 0.4274 |

**MLDR(en), RRF Re-ranking, k0=10**

|  | FTS | SVS | DVS | FTS+SVS | FTS+DVS | SVS+DVS | FTS+SVS+DVS |
| ---- | ---- | ---- | ---- | ---- | ---- | ---- | ---- |
| Recall | 0.755 | 0.735 | 0.6138 | 0.7937 | 0.7662 | 0.7388 | 0.7975 |
| MRR | 0.5946 | 0.5815 | 0.4502 | 0.6374 | 0.608 | 0.5523 | 0.6372 |

**MLDR(en), Tensor Re-ranking, k0=10**

|  | FTS | SVS | DVS | FTS+SVS | FTS+DVS | SVS+DVS | FTS+SVS+DVS |
| ---- | ---- | ---- | ---- | ---- | ---- | ---- | ---- |
| Recall | 0.755 | 0.735 | 0.6138 | 0.8063 | 0.79 | 0.7712 | 0.8137 |
| MRR | 0.5946 | 0.5815 | 0.4502 | 0.6523 | 0.6428 | 0.6289 | 0.6528 |
...
|  | FTS | SVS | DVS | FTS+SVS | FTS+DVS | SVS+DVS | FTS+SVS+DVS |
| ---- | ---- | ---- | ---- | ---- | ---- | ---- | ---- |
| p99 Latency (ms) | 0.41778564453124994 | 0.31439304351806635 | 0.44448852539062494 | 0.5038571357727051 | 0.5624103546142574 | 0.4548907279968259 | 0.569021701812744 |


**CQAD(en), RRF Re-ranking, k0=100**

|  | FTS+SVS | FTS+DVS | SVS+DVS | FTS+SVS+DVS |
| ---- | ---- | ---- | ---- | ---- |
| p99 Latency (ms) | 0.544302463531494 | 0.6464099884033199 | 0.5221343040466309 | 0.5887317657470702 |

**CQAD(en), RRF Re-ranking, k0=1000**

|  | FTS+SVS | FTS+DVS | SVS+DVS | FTS+SVS+DVS |
| ---- | ---- | ---- | ---- | ---- |
| p99 Latency (ms) | 0.6442642211914058 | 0.6940340995788574 | 0.6528592109680174 | 0.762052536010742 |

**CQAD(en), Tensor Re-ranking, k0=10**

|  | FTS+SVS | FTS+DVS | SVS+DVS | FTS+SVS+DVS |
| ---- | ---- | ---- | ---- | ---- |
| p99 Latency (ms) | 0.6320309638977047 | 0.9951424598693844 | 0.9165596961975098 | 1.0178089141845703 |

**MLDR(en), RRF Re-ranking, k0=10**

|  | FTS | SVS | DVS | FTS+SVS | FTS+DVS | SVS+DVS | FTS+SVS+DVS |
| ---- | ---- | ---- | ---- | ---- | ---- | ---- | ---- |
| p99 Latency (ms) | 0.5258059501647948 | 0.452795028686523 | 0.6273937225341796 | 0.5784964561462395 | 0.8451414108276365 | 0.8347630500793453 | 0.9124469757080076 |

**MLDR(en), RRF Re-ranking, k0=100**

|  | FTS+SVS | FTS+DVS | SVS+DVS | FTS+SVS+DVS |
| ---- | ---- | ---- | ---- | ---- |
| p99 Latency (ms) | 0.6678891181945767 | 0.9328079223632811 | 0.8420228958129877 | 1.0860919952392567 |

**MLDR(en), RRF Re-ranking, k0=1000**

|  | FTS+SVS | FTS+DVS | SVS+DVS | FTS+SVS+DVS |
| ---- | ---- | ---- | ---- | ---- |
| p99 Latency (ms) | 0.7959699630737304 | 1.0907721519470215 | 0.85888385772705 | 1.1773657798767088 |

**MLDR(en), Tensor Re-ranking, k0=10**

|  | FTS+SVS | FTS+DVS | SVS+DVS | FTS+SVS+DVS |
| ---- | ---- | ---- | ---- | ---- |
| p99 Latency (ms) | 0.766940116882324 | 0.9454798698425292 | 0.9958076477050773 | 1.0138845443725584 |

### 7. NV-Embed-v2 Model

CQAD(en)				
|  |  | RRF Re-ranking |  |  | Tensor Re-ranking |  |  |
| ---- | ---- | ---- | ---- | ---- | ---- | ---- | ---- |
|  | DVS | DVS+FTS | DVS+SVS | DVS+FTS+SVS | DVS+FTS | DVS+SVS | DVS+FTS+SVS |
| nDCG@10 | 0.4805446495961198 | 0.536742284039742 | 0.5644595218222419 | 0.5472234939946068 | 0.5061865215971734 | 0.5049389903406485 | 0.4859012943342446 |
| mean latency (ms) | 0.4264669053873439 | 1.0004259218835527 | 0.9377692155777269 | 1.0549356982966138 | 1.0633740455481657 | 0.9356082624690548 | 1.1032344429356278 |

MLDR(en)				
|  |  | RRF Re-ranking |  |  | Tensor Re-ranking |  |  |
| ---- | ---- | ---- | ---- | ---- | ---- | ---- | ---- |
|  | DVS | DVS+FTS | DVS+SVS | DVS+FTS+SVS | DVS+FTS | DVS+SVS | DVS+FTS+SVS |
| nDCG@10 | 0.48943960657037827 | 0.5110136138697989 | 0.4273864300580902 | 0.6160179972243639 | 0.6615114720056716 | 0.6414570443501512 | 0.6862887461638105 |
| mean latency (ms) | 0.5073714256286621 | 1.1079546809196472 | 1.005275845527649 | 1.1622318625450134 | 1.174769103527069 | 1.1386626958847046 | 1.1852282285690308 |

### 8. Qwen3-Embedding-8B Model

CQAD(en)				
|  |  | RRF Re-ranking |  |  | Tensor Re-ranking |  |  |
| ---- | ---- | ---- | ---- | ---- | ---- | ---- | ---- |
|  | DVS | DVS+FTS | DVS+SVS | DVS+FTS+SVS | DVS+FTS | DVS+SVS | DVS+FTS+SVS |
| nDCG@10 | 0.5728183490053151 | 0.5332271893757431 | 0.5546354397607459 | 0.5391389495344625 | 0.5043922033563303 | 0.5044722134565053 | 0.4855202633160356 |
| mean latency (ms) | 0.5520071193670772 | 1.2761298258593128 | 1.2485438851034565 | 1.3465275430375603 | 1.4009954063755692 | 1.33614707144962 | 1.4146982484562383 |

MLDR(en)				
|  |  | RRF Re-ranking |  |  | Tensor Re-ranking |  |  |
| ---- | ---- | ---- | ---- | ---- | ---- | ---- | ---- |
|  | DVS | DVS+FTS | DVS+SVS | DVS+FTS+SVS | DVS+FTS | DVS+SVS | DVS+FTS+SVS |
| nDCG@10 | 0.420580668267773 | 0.6055974282861926 | 0.5716954708652382 | 0.6589180813077603 | 0.6713202191602153 | 0.6566380127178236 | 0.688633797942507 |
| mean latency (ms) | 0.562007874250412 | 1.3208213448524475 | 1.2700340151786804 | 1.374703049659729 | 1.3919773697853088 | 1.3524025678634644 | 1.4283454418182373 |

### 9. KaLM-Embedding-Gemma3-12B-2511 Model

CQAD(en)				
|  |  | RRF Re-ranking |  |  | Tensor Re-ranking |  |  |
| ---- | ---- | ---- | ---- | ---- | ---- | ---- | ---- |
|  | DVS | DVS+FTS | DVS+SVS | DVS+FTS+SVS | DVS+FTS | DVS+SVS | DVS+FTS+SVS |
| nDCG@10 | 0.535097086550705 | 0.5159046166299106 | 0.5393990486301775 | 0.5334622259593865 | 0.4981185954909378 | 0.5025351924523913 | 0.4830547648022804 |
| mean latency (ms) | 0.5526808416767485 | 1.2365212106400993 | 1.2217980281562562 | 1.3116810731827073 | 1.3203116075552193 | 1.3043652674195114 | 1.3581514358520508 |

MLDR(en)				
|  |  | RRF Re-ranking |  |  | Tensor Re-ranking |  |  |
| ---- | ---- | ---- | ---- | ---- | ---- | ---- | ---- |
|  | DVS | DVS+FTS | DVS+SVS | DVS+FTS+SVS | DVS+FTS | DVS+SVS | DVS+FTS+SVS |
| nDCG@10 | 0.19909139109205876 | 0.5566523625023064 | 0.4835272144310021 | 0.6363193553312501 | 0.6663711884161507 | 0.6448008085575972 | 0.691069964656954 |
| mean latency (ms) | 0.4101237654685974 | 0.8549016714096069 | 0.8686545491218567 | 1.3639059662818909 | 1.2360128164291382 | 1.3002082705497743 | 1.580517292022705 |