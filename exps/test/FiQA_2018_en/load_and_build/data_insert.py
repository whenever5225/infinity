...
from FiQA_2018_en.search_tensor_rank.three_roads.sparse_dense_fulltext_search import terminate_process_tree
...
class InfinityClientForInsert:
    def __init__(self):
        ...
        self.test_table_name_prefix = "FiQA_2018_en_Table"
    ...
    def main(self):
        ...
        corpus = Dataset.from_csv('/home/ubuntu/data_download_data/data_download/dataset/FiQA-2018_en/fiqa/FiQA-2018_en_combine_corpus.csv')
        ...
        tensor_embedding_dir = '/home/ubuntu/data_download_data/embedding_reserve/FiQA-2018_en/tensor_embeddings/vectors'
