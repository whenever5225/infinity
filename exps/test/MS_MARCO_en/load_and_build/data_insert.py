...
from MS_MARCO_en.search_tensor_rank.three_roads.sparse_dense_fulltext_search import terminate_process_tree
...
class InfinityClientForInsert:
    def __init__(self):
        ...
        self.test_table_name_prefix = "MS_MARCO_en_Table"
    ...
    def main(self):
        ...
        corpus = Dataset.from_csv('/home/ubuntu/data_download_data/data_download/dataset/MS_MARCO_en/msmarco/MS_MARCO_en_combine_corpus.csv')
        ...
        # tensor_embedding_dir = '/home/ubuntu/data_download_data/embedding_reserve/MS_MARCO_en/tensor_embeddings/vectors'
        ...
        buffer = []
        while dense_file_idx < len(dense_names) or sparse_file_idx < len(sparse_names) :
