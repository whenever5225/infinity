...
try:
    ...
    infinity_table.drop_index('SCIDOCS_en_hnsw_index',ConflictType.Ignore)
    print("Start creating Hnsw index...")
    begin_hnsw_time = time.time()
    res = infinity_table.create_index("SCIDOCS_en_hnsw_index", index.IndexInfo("dense_col", index.IndexType.Hnsw,
                                                                            {
                                                                                "m": "16",
                                                                                "ef_construction": "200",
                                                                                "metric": "ip",
    ...
    infinity_table.show_index("SCIDOCS_en_hnsw_index")
