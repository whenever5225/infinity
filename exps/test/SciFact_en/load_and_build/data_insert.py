...
from SciFact_en.search_tensor_rank.three_roads.sparse_dense_fulltext_search import terminate_process_tree
...
class hybridsearchClientForInsert:
    def __init__(self):
        ...
        self.test_table_name_prefix = "SciFact_en_Table"
    ...
    def main(self):
        ...
        corpus = Dataset.from_csv('/home/ubuntu/data_download_data/data_download/dataset/SciFact_en/scifact/SciFact_en_combine_corpus.csv')
        ...
        tensor_embedding_dir = '/home/ubuntu/data_download_data/embedding_reserve/SciFact_en/tensor_embeddings/vectors'
