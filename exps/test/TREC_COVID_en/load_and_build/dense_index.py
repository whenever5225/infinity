...
try:
    ...
    hybridsearch_table.drop_index('TREC_COVID_en_hnsw_index',ConflictType.Ignore)
    print("Start creating Hnsw index...")
    begin_hnsw_time = time.time()
    res = hybridsearch_table.create_index("TREC_COVID_en_hnsw_index", index.IndexInfo("dense_col", index.IndexType.Hnsw,
                                                                            {
                                                                                "m": "16",
                                                                                "ef_construction": "200",
                                                                                "metric": "ip",
    ...
    hybridsearch_table.show_index("TREC_COVID_en_hnsw_index")
