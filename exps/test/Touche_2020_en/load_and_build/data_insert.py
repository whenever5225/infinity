...
from Touche_2020_en.search_tensor_rank.three_roads.sparse_dense_fulltext_search import terminate_process_tree
...
class hybridsearchClientForInsert:
    def __init__(self):
        ...
        self.test_table_name_prefix = "Touche_2020_en_Table"
    ...
    def main(self):
        ...
        corpus = Dataset.from_csv('/home/ubuntu/data_download_data/data_download/dataset/Touche_2020_en/webis-touche2020/Touche_2020_en_combine_corpus.csv')
        ...
        tensor_embedding_dir = '/home/ubuntu/data_download_data/embedding_reserve/Touche_2020_en/tensor_embeddings/vectors'
