...
try:
    ...
    infinity_table = infinity_db.get_table("Touche_2020_en_Table")
    infinity_table.drop_index('Touche_2020_en_ft_index',ConflictType.Ignore)
    begin_full_text_time = time.time()
    res = infinity_table.create_index("Touche_2020_en_ft_index",
                                            index.IndexInfo("fulltext_col", index.IndexType.FullText, ft_params),
                                            ConflictType.Error)
    infinity_table.show_index("Touche_2020_en_ft_index")
    end_full_text_time = time.time()
    print(infinity_table.show_index('Touche_2020_en_ft_index'))
