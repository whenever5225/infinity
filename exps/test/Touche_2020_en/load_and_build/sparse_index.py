...
try:
    ...
    hybridsearch_table.drop_index('TREC_COVID_en_bmp_index',ConflictType.Ignore)
    print("Start creating Bmp index...")
    begin_hnsw_time = time.time()
    res = hybridsearch_table.create_index("TREC_COVID_en_bmp_index", index.IndexInfo("sparse_col", index.IndexType.BMP,
                                                                            {
                                                                                "block_size": "8",
                                               ...
                                               ConflictType.Error)
    hybridsearch_table.optimize("TREC_COVID_en_bmp_index", {"topk": "1000"})
    end_hnsw_time = time.time()
    hybridsearch_table.show_index("TREC_COVID_en_bmp_index")
